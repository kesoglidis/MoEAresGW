...
# injections_file = 'dataset-4/v2/val_injections_s24w6d1_1.hdf'
...
# np.save('dataset-4/v2/val_injections_s24w6d1_1.25s.npy', waveforms)


hdf_filename = 'dataset-4/v2/train_background_s24w61w_1.hdf'
injections_file = 'dataset-4/v2/train_injections_s24w61w_1.hdf'
...
np.save('dataset-4/v2/train_injections_s24w61w_1.25s_all.npy', waveforms)